...
public class JhipsterRamApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterRamApp.class);

    private final Environment env;

    public JhipsterRamApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterRam.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterRamApp.class);
